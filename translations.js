...
const translations = {
    en: {
        ...
        lblScopeValidation: "Was work performed according to original scope of work?",
        optYes: "Yes",
        optNo: "No",
        optPartly: "Partly",
        lblScopeDeviationDesc: "Please explain the scope deviation",
        ...
        msgSubmitBlocked: "Not all required fields are filled in. Check customer name, engineer(s), start/end time, and the work description.",
        lblEngineersRequiredHint: "* At least one row must have name, start and end time filled in"
    },
    nl: {
        ...
        lblScopeValidation: "Is het werk uitgevoerd volgens de oorspronkelijke scope van het werk?",
        optYes: "Ja",
        optNo: "Nee",
        optPartly: "Gedeeltelijk",
        lblScopeDeviationDesc: "Leg de scope-afwijking uit",
        ...
        msgSubmitBlocked: "Niet alle verplichte velden zijn ingevuld. Controleer klantnaam, engineer(s), start-/eindtijd en de werkomschrijving.",
        lblEngineersRequiredHint: "* Minstens één rij moet volledig zijn: naam, start- en eindtijd"
    },
    de: {
        ...
        lblScopeValidation: "Wurde die Arbeit gemäß dem ursprünglichen Arbeitsumfang durchgeführt?",
        optYes: "Ja",
        optNo: "Nein",
        optPartly: "Teilweise",
        lblScopeDeviationDesc: "Bitte erläutern Sie die Abweichung vom Arbeitsumfang",
        ...
        msgSubmitBlocked: "Nicht alle Pflichtfelder sind ausgefüllt. Überprüfen Sie Kundenname, Techniker, Start-/Endzeit und die Arbeitsbeschreibung.",
        lblEngineersRequiredHint: "* Mindestens eine Zeile muss vollständig sein: Name, Start- und Endzeit"
    },
    it: {
        ...
        lblScopeValidation: "Il lavoro è stato eseguito secondo l'ambito originale del lavoro?",
        optYes: "Sì",
        optNo: "No",
        optPartly: "Parzialmente",
        lblScopeDeviationDesc: "Si prega di spiegare la deviazione dell'ambito",
        ...
        msgSubmitBlocked: "Non tutti i campi obbligatori sono stati compilati. Controlla nome cliente, tecnico/i, orario di inizio/fine e la descrizione del lavoro.",
        lblEngineersRequiredHint: "* Almeno una riga deve essere completa: nome, ora di inizio e fine"
    },
    pl: {
        ...
        lblScopeValidation: "Czy praca została wykonana zgodnie z pierwotnym zakresem prac?",
        optYes: "Tak",
        optNo: "Nie",
        optPartly: "Częściowo",
        lblScopeDeviationDesc: "Proszę wyjaśnić odchylenie od zakresu",
        ...
        msgSubmitBlocked: "Nie wszystkie wymagane pola zostały wypełnione. Sprawdź nazwę klienta, inżyniera/ów, godzinę rozpoczęcia/zakończenia oraz opis wykonanej pracy.",
        lblEngineersRequiredHint: "* Co najmniej jeden wiersz musi być kompletny: imię, godzina rozpoczęcia i zakończenia"
    }
};
